...
class Product : ProductItem, Parcelable {
	...
	constructor(id: Long = System.currentTimeMillis(), name: String, description: String, category: String, url: String, price: String,
	            ...
	            shop: Shop, logo: String, key: String? = null) : super() {
		this.id = id
		this.name = name
	...
	override fun toString(): String {
		return "Product(id=$id, name=$name, description=$description, category=$category, url=$url, price=$price, discount=$discount, tag=$tag, quantity=$quantity, brand=$brand, animated=$animated, shop=$shop, logo=$logo, key=$key, timestamp=$timestamp)"
	}
