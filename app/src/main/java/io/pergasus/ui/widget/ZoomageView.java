...
public class ZoomageView extends ImageView implements OnScaleGestureListener {
	 ...
	 * {@link AutoResetMode#ALWAYS ALWAYS}, or {@link AutoResetMode#NEVER NEVER}
	 */
	public void setAutoResetMode(@AutoResetMode int autoReset) {
	...
	private void animateToStartMatrix() {
		...
		Matrix beginMatrix = new Matrix(getImageMatrix());
		beginMatrix.getValues(matrixValues);
		
		//difference in current and original values
		float xsdiff = startValues[Matrix.MSCALE_X] - matrixValues[Matrix.MSCALE_X];
		float ysdiff = startValues[Matrix.MSCALE_Y] - matrixValues[Matrix.MSCALE_Y];
		float xtdiff = startValues[Matrix.MTRANS_X] - matrixValues[Matrix.MTRANS_X];
		float ytdiff = startValues[Matrix.MTRANS_Y] - matrixValues[Matrix.MTRANS_Y];
	...
	public boolean onScale(ScaleGestureDetector detector) {
		...
		float projectedScale = scaleBy * matrixValues[Matrix.MSCALE_X];
