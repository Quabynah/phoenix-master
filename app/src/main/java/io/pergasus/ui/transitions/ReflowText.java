...
package io.pergasus.ui.transitions;
...
import io.pergasus.ui.widget.BaselineGridTextView;
...
public class ReflowText extends Transition {
	...
	private static final String PROPNAME_DATA = "pergasus:reflowtext:data";
	private static final String PROPNAME_TEXT_SIZE = "pergasus:reflowtext:textsize";
	private static final String PROPNAME_BOUNDS = "pergasus:reflowtext:bounds";
